...
export class SampleFormComponent implements OnInit {
    ...
    constructor( @Inject(FormBuilder) fb: FormBuilder) { this.fb = fb; }
    ngOnInit() {
    ...
    private wireValidations() {
        ...
        // 4th vs 5th
        this.control4.setValidators(this.forbiddenValueValidator(this.control5, 'forth'));
        // this.wireRelation(this.control4, this.control5, true);
        this.control4.controlRelations.addRelatedControls(this.control5);

        this.control5.setValidators(this.forbiddenValueValidator(this.control4, 'fifth'));
        ...
        // 3rd vs 1st
        this.control3.setValidators(this.forbiddenValueValidator(this.control1, 'third'));
        ...
        // 2nd vs 6th
        this.control2.setValidators(this.forbiddenValueValidator(this.control6, 'second'));
        ...
        // 6th vs 7th
        this.control6.setValidators(this.forbiddenValueValidator(this.control7, 'sixth'));
        ...
        // 10th vs 11th
        this.control10.setValidators(this.forbiddenValueValidator(this.control11, 'eleventh'));
        ...
        this.control1.setValidators(this.formArrayMissingValueValidator(this.array4, 'first'));
    ...
    private forbiddenValueValidator(refControl: AbstractControl, controlName: string): ValidatorFn {
    ...
    private formArrayMissingValueValidator(refControl: FormArray, controlName: string): ValidatorFn {
        return (control: AbstractControl): { [key: string]: any } => {
