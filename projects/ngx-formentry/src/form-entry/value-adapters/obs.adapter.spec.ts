...
describe('Obs Value Adapter: ', () => {
  ...
  it('should be defined', inject([ObsValueAdapter], (s: ObsValueAdapter) => {
    expect(s).toBeTruthy();
  }));
  describe('getObsPayload', () => {
    it('should return payload from the form', inject(
      [ObsValueAdapter, FormFactory],
      (s: ObsValueAdapter, f: FormFactory) => {}
    ));
  });

  describe('processMultiSelect', () => {
    it('should exist', inject([ObsValueAdapter], (s: ObsValueAdapter) => {
      const processMultiSelectSpy = spyOn(s, 'processMultiSelect');
      expect(processMultiSelectSpy).toBeTruthy();
    }));
    it('should return payload for multi select given a concept and values', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
  ...
  describe('updateOrVoidObs', () => {
    ...
    it('should insert updated obs into payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const obsPayload = [];
        s.updateOrVoidObs(
    ...
    it('should insert voided obs into payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const obsPayload = [];
        s.updateOrVoidObs(
  ...
  describe('processNewMultiSelectObs', () => {
    ...
    it('should insert new multiselect obs into payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const obsPayload = [];
        s.processNewMultiSelectObs(
          [
  ...
  describe('processDeletedMultiSelectObs', () => {
    ...
    it('should insert deleted multiselect obs into payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const obsPayload = [];
        s.processDeletedMultiSelectObs(
          [
  ...
  describe('createGroupDeletedObs', () => {
    ...
    it('should return deleted obs given a payload of existing groups', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        let obsPayload = [];
        obsPayload = s.createGroupDeletedObs([
          { uuid: 'uuid' },
          { uuid: 'uuid2' }
        ]);
        expect(obsPayload).toEqual([
  ...
  describe('createGroupNewObs', () => {
    ...
    it('should return new obs given a mapped obs group payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const obsPayload = s.createGroupNewObs(
  ...
  describe('leftOuterJoinArrays', () => {
    ...
    it('should return the objects in the first array that are not in the second', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const joined = s.leftOuterJoinArrays(
          [
  ...
  describe('mapInitialGroup', () => {
    ...
    it('should properly map group payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const payload = {
  ...
  describe('getMultiselectValues', () => {
    ...
    it('it should return an array of concept uuids given multiselect payload', inject(
      [ObsValueAdapter],
      (s: ObsValueAdapter) => {
        const joined = s.getMultiselectValues([
          { value: { uuid: 'uuid1' } },
          { value: { uuid: 'uuid2' } }
        ]);
  ...
  describe('getObsPayload', () => {
    ...
    it('should return correct payload given an array of nodes with and without values set', inject(
      [ObsValueAdapter, FormFactory],
      (s: ObsValueAdapter, f: FormFactory) => {
  ...
  describe('Set Values', () => {
    ...
    it('should correctly set the values given question nodes and obs payload', inject(
      [ObsValueAdapter, FormFactory],
      (s: ObsValueAdapter, f: FormFactory) => {
