...
export class ConceptService {
  ...
  private headers = new HttpHeaders({
         'Authorization': 'Basic ' + btoa('admin@icrc.org:cnR0OCGfSWEHEPc53Kr9'),
  ...
  constructor(
    ...
    // const credentials = sessionStorageService.getItem(
    //   Constants.CREDENTIALS_KEY
    // );
    this.baseUrl = 'http://localhost:4200/openmrs/';
    // this.headers.append('Content-Type', 'application/json');
    // this.headers.append('Authorization', 'Basic ' + btoa('admin@icrc.org:cnR0OCGfSWEHEPc53Kr9'));
  }
  ...
  public searchConceptByUUID(conceptUUID: string): Observable<any> {
    return this.http
      .get(`${this.baseUrl}/ws/rest/v1/concept/${conceptUUID}?v=full&lang=fr`, {
        headers: this.headers
      })
      .pipe(
  ...
  public searchBulkConceptByUUID(conceptUuids: any) {
